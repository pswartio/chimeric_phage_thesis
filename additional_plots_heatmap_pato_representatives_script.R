...
library(scales)
# Set the file names
lengths_file <- "/Users/pimswart/P_all_separate_representatives_dir/P_all_separate_representatives_fa_lengthsfake.txt"
heatmap_file <- "/Users/pimswart/sourmash_compare_P_all_separate_representatives_fa_catted_scaled1000k31_ordered.csv"
...
#Display plot
seq_lengths_plot
ggsave(filename='asdfasdfasdf',plot=seq_lengths_plot, height=10,width=1.5,units='cm',dpi=1000)
...
######## MAPPING PLOT
best_mappings_file = "/Users/pimswart/2_extracted_best_mappings_minimap_P_all_separate_representatives_fa_catted_cat_references_namecharactersfixedforcircoletto_allprophageregionsmaskednotjustregion2_Ecolibl21DE3_LE392_and_maskedprophageregions_and_parentalphages"
